...
public class ConsultarEmpleadosAle {
	...
	//BYTES 4 del id(int), 20 del nombre(10 caracteres), 4 del depto(int) y 8 del salario(double)
	...
	public static void main(String[] args) {
		...
		try {
			...
			if(pos < raf.length()) {
				...
				id = raf.readInt();
				//segundo leemos el nombre y necesito leerlo caracter a caracter y para eso uso un array de caracteres
