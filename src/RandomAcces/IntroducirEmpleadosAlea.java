...
public class IntroducirEmpleadosAlea {
	...
	public static void main(String[] args) {
		...
		try {
			...
			long tam = raf.length();
			// cada registro ocupa 36 bytes (4 del ID, 20 del nombre, 4 del Dept y 8 del
			// Salario String son 2bytes por cada caracter.

			tam = tam / 36; // numero de registros

			/*
			 * empezamos a escribir definimos un StringBuffer para almacenar el nombre y que
			 * siempre tenga tamaño 10, rellenando con espacios en blanco
			 */
